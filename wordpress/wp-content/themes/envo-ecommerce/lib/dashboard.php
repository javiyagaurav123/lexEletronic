...
function envo_ecommerce_admin_notice() {
	...
	if ( !get_user_meta( $user_id, esc_html( $theme_data->get( 'TextDomain' ) ) . '_notice_ignore' ) ) {
		?>
		<div class="notice envo-ecommerce-notice">
...
function envo_ecommerce_recommended_import_construct() {
	...
	if ( is_plugin_active( 'one-click-demo-import/one-click-demo-import.php' ) ) {
		?>
		<a href="?page=pt-one-click-demo-import" class="nav-tab<?php echo $tab == 'import_data' ? ' nav-tab-active' : null; ?>"><?php esc_html_e( 'One Click Demo Import', 'envo-ecommerce' ) ?></a>
	<?php } else { ?>
