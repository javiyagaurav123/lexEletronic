...
function envo_ecommerce_customizer_demo_content( $wp_customize ) {
	...
	if ( is_plugin_active( 'one-click-demo-import/one-click-demo-import.php' ) ) {
		$theme_demo_content_desc .= '<p><a class="button button-primary" href="' . esc_url( admin_url( 'themes.php?page=pt-one-click-demo-import' ) ) . '" title="">' . esc_html__( 'Import demo data', 'envo-ecommerce' ) . '</a></p>';
	} else {
