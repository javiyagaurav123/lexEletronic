jQuery(function(s) {
    var e = [
        ["#customize-save-button-wrapper", "all", "ct-reset", "ct-reset-main", boldPhotographyCustomizerReset.confirm, boldPhotographyCustomizerReset.reset]
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                ...
                nonce: boldPhotographyCustomizerReset.nonce.reset,
                section: o[1]
            };
