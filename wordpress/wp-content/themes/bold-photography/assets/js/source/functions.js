 /* global boldPhotographyOptions */
 /*
 * Custom scripts
 * Description: Custom scripts for Bold Photography Pro
 */

( function( $ ) {
	$( window ).on( 'load.boldPhotography resize.boldPhotography', function () {
		// Owl Carousel.
		if ( $.isFunction( $.fn.owlCarousel ) ) {
			// Featured Slider
			var sliderLayout = 1;
			var sliderOptions = {
				rtl:boldPhotographyOptions.rtl ? true : false,
				autoHeight:true,
				margin: 0,
				items: 1,
				nav: true,
				...
				navText: [boldPhotographyOptions.iconNavPrev,boldPhotographyOptions.iconNavNext]
			};
	...
	function initMainNavigation( container ) {
		...
		var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false })
			.append( boldPhotographyOptions.dropdownIcon )
			.append( $( '<span />', { 'class': 'screen-reader-text', text: boldPhotographyOptions.screenReaderText.expand }) );
		...
		container.find( '.dropdown-toggle' ).click( function( e ) {
			...
			// jscs:enable
			screenReaderSpan.text( screenReaderSpan.text() === boldPhotographyOptions.screenReaderText.expand ? boldPhotographyOptions.screenReaderText.collapse : boldPhotographyOptions.screenReaderText.expand );
		} );
	}
