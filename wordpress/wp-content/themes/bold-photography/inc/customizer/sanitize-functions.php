<?php
/**
 * Bold Photography Theme Options Sanitization Functions
 *
 ...
 */
function bold_photography_sanitize_select( $input, $setting ) {
 ...
 */
function bold_photography_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function bold_photography_sanitize_post( $input ) {
 ...
 */
function bold_photography_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function bold_photography_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function bold_photography_sanitize_number_range( $number, $setting ) {
